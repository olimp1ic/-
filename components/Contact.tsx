...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-32 md:py-40 px-6 md:px-12 bg-[#eeede9]">
          ...
          <div className="reveal">
            ...
            <div className="flex flex-col gap-3 mb-12">
              <a
                ...
                className="group flex items-center gap-4 px-6 py-4 border border-[#d4d3cf] hover:border-[#25D366]/50 hover:bg-[#25D366]/5 transition-all duration-300 bg-white/40"
              >
                ...
                <span className="text-[11px] tracking-[0.25em] uppercase text-[#5a5a5a] group-hover:text-[#25D366] transition-colors duration-300">WhatsApp</span>
                <span className="ml-auto text-[10px] tracking-[0.15em] text-[#b0afa9] font-light">+7 929 989 00 78</span>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center gap-4 px-6 py-4 border border-[#d4d3cf] hover:border-[#229ED9]/50 hover:bg-[#229ED9]/5 transition-all duration-300 bg-white/40"
              >
                ...
                <span className="text-[11px] tracking-[0.25em] uppercase text-[#5a5a5a] group-hover:text-[#229ED9] transition-colors duration-300">Telegram</span>
                <span className="ml-auto text-[10px] tracking-[0.15em] text-[#b0afa9] font-light">@smartdecorru</span>
              </a>
            </div>

            <div className="space-y-4 text-sm font-light border-t border-[#d4d3cf] pt-8">
              <div className="flex items-start gap-4">
                <span className="text-[10px] tracking-[0.3em] uppercase text-[#b0afa9] w-20 flex-shrink-0 mt-0.5">Телефон</span>
                <a href="tel:+79299890078" className="text-[#5a5a5a] hover:text-[#1c1c1c] transition-colors duration-300">+7 929 989 00 78</a>
              </div>
              <div className="flex items-start gap-4">
                <span className="text-[10px] tracking-[0.3em] uppercase text-[#b0afa9] w-20 flex-shrink-0 mt-0.5">Почта</span>
                <a href="mailto:infosmartdecor@mail.ru" className="text-[#5a5a5a] hover:text-[#1c1c1c] transition-colors duration-300">infosmartdecor@mail.ru</a>
              </div>
              <div className="flex items-start gap-4">
                <span className="text-[10px] tracking-[0.3em] uppercase text-[#b0afa9] w-20 flex-shrink-0 mt-0.5">Адрес</span>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="pt-4">
                  <button type="submit" disabled={loading}
                    className="w-full py-4 bg-[#1c1c1c] text-[#f5f4f2] text-[11px] tracking-[0.3em] uppercase font-light hover:bg-[#2e2e2e] transition-all duration-300 disabled:opacity-50 disabled:cursor-wait">
