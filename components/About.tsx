const stats = [
  ...
  { value: "∞",    label: "фактур по образцу" },
  { value: "100%", label: "своё оборудование" },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-32 items-center">
          ...
          <div className="reveal">
            ...
            <div className="space-y-5 text-[#7a7a7a] font-light leading-relaxed text-base">
              <p>
                ООО «Смарт Декор» выполняет отделочные работы на объектах жилого и
                коммерческого строительства: штукатурка и гипсокартон, базовая шпаклёвка,
                безвоздушная покраска, декоративная штукатурка.
              </p>
              <p>
                Работаем механизированным способом — это даёт скорость и ровный слой
                на больших площадях. Берёмся за объекты любого масштаба.
              </p>
              <p>
                Используем собственное промышленное оборудование и премиальные материалы.
                Отвечаем за результат на каждом этапе — от подготовки основания
